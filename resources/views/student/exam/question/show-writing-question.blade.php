                ...
                <div class="card border-primary" style="width: 900px">
                    ...
                    @csrf
                        ...
                        <fieldset>
                            <div class="card">
                                <div class="card-header border-primary">
                                    <h4 class="h4 text-center font-weight-bolder">Formal Email</h4>
                                    {{--                                    <span class="text-muted d-block text-center font-weight-light">Select the correct word from the dropdown on the right</span>--}}
                                </div><!-- /.card-header -->
                                <div class="card-body">
                                    <h4 class="h4">{{ $formalEmail->topic }}</h4>
                                    ...
                                    <div id="formalEmail"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="informalEmail-subject" name="formalEmail[subject]" placeholder="Subject" class="form-control">
                                        </div><!-- /.form-group -->
                                        <div class="form-group">
                                            <label for="formalEmail-body">Body</label>
                                            <textarea name="formalEmail[body]" id="formalEmail-body" rows="5" class="form-control"
                                                      spellcheck="false" word-limit="true" max-words="100"
                                                      min-words="40"></textarea>
                                            <span></span>
                                            <div class="writing_error"></div>
