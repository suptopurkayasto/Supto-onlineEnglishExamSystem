...
@section('content')
    @if($questionCategories->count() > 0)
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">All question categories</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example"
    ...
    @else
        <div class="empty-data-section">
            ...
            <a href="{{ route('admin.question-categories.create') }}" class="btn btn-lg mt-4 bg-gradient-primary">Add Question Category</a>
