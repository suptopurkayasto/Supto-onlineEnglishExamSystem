...
@section('title', 'Add Fill In The Gap Sentence')
        ...
        <div class="col-12 col-md-8">
            <div class="card shadow">
                <div class="card-header">
                    <h3 class="h3 card-title">Add Fill In The Gap Sentence</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('teachers.questions.fill-in-the-gaps.store') }}" method="post">
                        @csrf
