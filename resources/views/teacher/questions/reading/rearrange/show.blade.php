        ...
        <div class="col-12 col-md-8">
            <div class="card shadow">
                <div class="card-header">
                    <h3 class="h3 card-title">Show Rearrange</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            <div class="col-12 col-md-10">
                                <div class="row">
                                    <div class="col col-md-6">
                                        <a href="{{ route('teachers.questions.rearranges.edit', $rearrange->id) }}?exam={{ request()->get('exam') }} }}"
                                           class="btn bg-gradient-primary btn-block"><i class="far fa-edit mr-1"></i> Edit
                                            Rearrange
                                        </a>
                                    </div><!-- /.col col-md-6 -->
                                    <div class="col col-md-6">
                                        <form action="{{ route('teachers.questions.synonyms.destroy', $rearrange->id) }}"
                                              method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-block"
                                                    onclick="return confirm('Are you sure you want to delete: {{ $rearrange->line_1 }}')">
                                                <i
                                                    class="fas fa-trash-alt mr-1"></i> Delete Rearrange
                                            </button>
                                        </form>
                                    </div><!-- /.col col-md-6 -->
                                </div><!-- /.row -->
